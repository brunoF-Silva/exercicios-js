...
class Pai extends Avo {
  constructor(sobrenome, profissao = "Professor") {
    // O construtor do pai (quem recebe os parâmetros da suposta instância, vai chamar o construtor do pai atravez de "super") // Atravez deste construtor podemos passar um valor sobrenome para avo e personalizar o avô
    super(sobrenome); // chamando o construtor da superclasse (avo)
